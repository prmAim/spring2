...
public class UserProviderJdbcImpl implements IUserProvider {
    ...
    public SystemUser getUser(String userName) {
        try (Connection connection = sql2o.open()) {
            // findUserTemplate =  наименование запроса к БД. Сущность SystemUser.class, в которую этот запрос попалет
    ...
    public void update(SystemUser user) {
        // MergeUserTemplate =  наименование запроса к БД. Сущность Long.class, в которую этот запрос попалет
        try (Connection connection = sql2o.open()) {
    ...
    public List<Claim> getClaims(Long userId) {
        try (Connection connection = sql2o.open()) {
            // getClaimsTemplate =  наименование запроса к БД. Сущность Claim.class, в которую этот запрос попалет
